...
with tab2:
    ...
    X
    st.write("#Memisahkan dengan dataset asli dimana Modal x = menyimpan fitur kumpulan data kami tanpa label dan Huruf kecil y =memegang label yang sesuai untuk instance di x.")
    
    x = data[["mass","width","height","color_score"]]
    y = data["fruit_label"].values
    
    st.write("MinMaxScaler digunakan untuk mengubah skala nilai terkecil dan terbesar dari dataset ke skala tertentu.pada dataset ini skala terkecil =0, skala terbesar=1")
